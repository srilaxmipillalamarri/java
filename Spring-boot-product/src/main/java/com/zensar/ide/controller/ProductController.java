...
public class ProductController {
	...
	@GetMapping(value="/products/{productName}/{expDate}")
	public ResponseEntity<List<ProductDto>> getByProductNameAndExpDate(@PathVariable("productName")String productName,@PathVariable("expDate")String expDate){
		return new ResponseEntity<List<ProductDto>>(productService.getByProductNameAndExpDate(productName, expDate),HttpStatus.OK);
